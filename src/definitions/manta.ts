...
export const manta: EcoChain = {
  ...
  isCalderaChain: true,
  stables: {
    USDC: { address: '0xb73603C5d87fA094B7314C74ACE2e64D165016fb', decimals: 6 },
    USDT: { address: '0xf417F5A458eC102B90352F697D6e2Ac3A3d2851f', decimals: 6 },
  },
}
...
export const mantaSepolia: EcoChain = {
  ...
  isCalderaChain: true,
  stables: {
    USDC: { address: '0x0652aEc2DeE0Fee9D05E614c95Ce8A01a7336cD8', decimals: 6 },
    USDT: { address: '0xC040bB09ffF7EBb7FDf38831B7c582afddB2CcFE', decimals: 6 },
  },
}
